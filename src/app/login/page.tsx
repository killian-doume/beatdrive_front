...
export default function Login() {
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    try {
      ...
      // Ajout de l'alerte TailwindCSS
      const alertBox = document.createElement("div");
      alertBox.className =
        "fixed top-5 left-1/2 transform -translate-x-1/2 bg-red-500 text-white text-sm font-medium px-4 py-2 rounded-md shadow-lg animate-fade-in-out";
      alertBox.innerText = "Une erreur est survenue lors de la requête. Mot de passe et/ou Email invalide";

      // Ajoute l'alerte au body
